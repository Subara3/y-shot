...
REM ZIP作成
echo [3/3] ZIP作成中...
if exist release\y-shot_v3.0.zip del release\y-shot_v3.0.zip
powershell -Command "Compress-Archive -Path 'release\y-shot' -DestinationPath 'release\y-shot_v3.0.zip'"

echo.
echo === 完了: release\y-shot_v3.0.zip ===
pause
